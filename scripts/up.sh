...
#   export STRIPE_PRICE_PRO_<BAND>_<MONTH|YEAR>=price_...  # BAND = STARTER STUDIO PRACTICE UNLIMITED
...
STRIPE_PRICE_PRO_STARTER_MONTH="${STRIPE_PRICE_PRO_STARTER_MONTH:-}" \
STRIPE_PRICE_PRO_STARTER_YEAR="${STRIPE_PRICE_PRO_STARTER_YEAR:-}" \
STRIPE_PRICE_PRO_STUDIO_MONTH="${STRIPE_PRICE_PRO_STUDIO_MONTH:-}" \
STRIPE_PRICE_PRO_STUDIO_YEAR="${STRIPE_PRICE_PRO_STUDIO_YEAR:-}" \
STRIPE_PRICE_PRO_PRACTICE_MONTH="${STRIPE_PRICE_PRO_PRACTICE_MONTH:-}" \
STRIPE_PRICE_PRO_PRACTICE_YEAR="${STRIPE_PRICE_PRO_PRACTICE_YEAR:-}" \
STRIPE_PRICE_PRO_UNLIMITED_MONTH="${STRIPE_PRICE_PRO_UNLIMITED_MONTH:-}" \
STRIPE_PRICE_PRO_UNLIMITED_YEAR="${STRIPE_PRICE_PRO_UNLIMITED_YEAR:-}" \
