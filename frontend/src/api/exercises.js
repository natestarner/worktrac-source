...
export function addExercise({ name, setupFieldNames }) {
  return apiClient.post('/api/exercises', { name, setupFieldNames });
}

export function updateExercise(exerciseId, { name, setupFieldNames }) {
  return apiClient.put(`/api/exercises/${exerciseId}`, { name, setupFieldNames });
}
