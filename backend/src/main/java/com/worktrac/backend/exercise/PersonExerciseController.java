...
// applying the household's shared tags, and the custom setup-field overlay. Shares the
// /api/people/{personId}/exercises namespace with SetupValueController (base setup fields),
// which lives on the /{exerciseId}/setup-* subpaths.
@RestController
