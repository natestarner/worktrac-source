...
// values the database has no opinion on yet (membersSeeEveryone arrives in phase 3, accountIsPro
// is derived, not stored). Collapsing them would tie the request-time model to the schema.
