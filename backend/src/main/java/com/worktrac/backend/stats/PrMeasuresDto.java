...
// sessionVolume and bestSetVolume are raw weight or weight x reps, so for an exercise whose whole
// history is bodyweight they would be a column of "0 lb"; for a hold reps are 0, so both volume
// measures and totalReps collapse the same way. That is the call ExerciseRecordsDto's
