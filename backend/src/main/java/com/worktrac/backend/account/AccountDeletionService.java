...
// workout_sets, setup_values, person_exercise -> person_exercise_fields/person_exercise_tags)
// fire and clear the FK rows that still reference this account's exercises
