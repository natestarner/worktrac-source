...
/**
 * A household reached Pro for the first time ever, via Stripe. Published from
 * {@code SubscriptionService.applyStripeState} at most once per account, guarded by
 * {@code Subscription.proWelcomeSentAt} -- unlike {@link AccountPlanChangedEvent}, which is
 ...
 */
public record ProUpgradedEvent(Long accountId) {
}
