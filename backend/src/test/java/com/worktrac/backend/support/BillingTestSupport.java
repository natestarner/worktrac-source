...
// Puts a test household on Plus without going anywhere near Stripe.
//
...
// the honest fix is to say "this household is Plus" out loud rather than to weaken the gate they
// now trip over.
//
