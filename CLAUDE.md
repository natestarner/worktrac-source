...
| History sync (fingerprinted months, the rowversion fingerprint) | `backend-core.md`, `frontend-core.md` | `docs/architecture/history-sync.md` |
...
| Billing, plans & entitlement (Stripe, the four-tier split) | `billing.md` | `docs/architecture/billing.md` |
| Coaching tiers (Pro now, Team next): roles, client privacy, vocabulary | `coaching.md` | — |
